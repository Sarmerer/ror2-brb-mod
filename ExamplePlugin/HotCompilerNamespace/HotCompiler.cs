...
return;
#endif
            const string pathToHotReloadMain = "E:\\dev\\projects\\ror2-brb-mod\\ExamplePlugin\\HotCompilerNamespace\\HotReloadMain.cs";
           ...
           .FirstOrDefault(m => m.Name == nameof(HotReloadMain.HotReloadEntryPoint));
            ...
            ExamplePlugin.Log.Info($"CompilationCount: {CompilationCount++}");
        }
